...
public class ActivityMain extends AppCompatActivity implements View.OnClickListener {
    ...
    Button mTinyWindow, mListView, mDirectFullscreen, mApi, mWebView, echat;
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.webview:
                ...
                break;
            case R.id.echat:
                startActivity(new Intent(this, EChatCustomActivity.class));
        }
    }
